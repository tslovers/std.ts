 ...
 */
export function ascendingComparison(a: any, b: any): number {
 ...
 * @return 0 if a equals b, 1 if a < b, -1 if b > a of a or b are undefined.
 */
export function descendingComparison(a: any, b: any): number {
  if (a === undefined || b === undefined) {
    return -1;
  }
  if (a === b) {
...
export function isSorted(a: any[],
                         compare: criterion = ascendingComparison): boolean {
